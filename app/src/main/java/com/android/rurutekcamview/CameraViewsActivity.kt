...
class CameraViewsActivity : AppCompatActivity(), SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    private class MediaInitializationTask(activity: CameraViewsActivity) :
        AsyncTask<Void?, Void?, Void?>() {
        private val activityWeakReference: WeakReference<CameraViewsActivity> =
